...
$(function() {
    ...
    var dialogChild = $("#highchart-lineBox").clone();
    var content = dialogChild;
    // Set to full screen
    content.addClass('fullsize');
// clone

var dialogParent = $("#highchart-lineBox").parent();

/* Dialog Box */
var dialog = $("#highchart-lineBox").dialog({
    height: fullH,
    width: fullW,
    resizable: false,
    modal: true,
   ...
   close: function(){                                
     ...
     var originalDialogDiv = dialog.dialog("widget").find("#highchart-lineBox").clone();
